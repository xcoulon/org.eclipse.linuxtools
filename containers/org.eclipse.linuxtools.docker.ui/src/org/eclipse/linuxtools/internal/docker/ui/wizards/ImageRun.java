...
public class ImageRun extends Wizard {
	...
	public IDockerHostConfig getDockerHostConfig() {
		...
		Iterator<ContainerLinkModel> iterator = selectionModel.getLinks()
		...
		for (@SuppressWarnings("unchecked")
		Iterator<DataVolumeModel> iterator = resourcesModel.getDataVolumes()
				.iterator(); iterator.hasNext();) {
